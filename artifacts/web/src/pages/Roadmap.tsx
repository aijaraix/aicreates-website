...
const PHASES = [
  {
    n: "Priority 1",
    title: "Foundations and preservation",
    desc: "Reconcile the existing product, accounts and operating records before changing infrastructure.",
    bullets: [
      "Preserve workspace and agent identities",
      "Verify the source of truth",
      "Review access and approval boundaries",
    ],
  },
  {
    n: "Priority 2",
    title: "Independent operations",
    desc: "Prepare the runtime and connected services for verified independent hosting.",
    bullets: [
  ...
  {
    n: "Priority 4",
    title: "Builder and knowledge",
    desc: "Connect technical delivery and business context to the operating workflow.",
    bullets: [
      "Jarvis building experience",
      "Workspace-scoped knowledge",
      "Reviewed handoffs and working artifacts",
    ],
  },
  {
    n: "Priority 5",
    title: "Developer access",
    desc: "Expand integration and reusable-skill options as interfaces are validated.",
    bullets: [
      "Versioned integration contracts",
      "Developer documentation",
      "Reviewed skill distribution",
    ],
  },
  {
    n: "Priority 6",
    title: "Operational scale",
    desc: "Expand deployment options based on verified reliability and customer requirements.",
    bullets: [
      ...
      <section className="relative pt-28 pb-14 md:pt-36 md:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-5xl">
            ...
            >
              Real value early. Long-term defensibility through data, product
              experience, and proprietary model development.
            </motion.p>
          </div>
        </div>
      </section>
                ...
                >
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 hover:border-[#00F5D4]/30 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-xs font-mono text-[#00F5D4] tracking-widest">
                        {p.n}
                      </span>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Roadmap describes current intent and direction. Sequence, scope,
              and timing may change based on development progress, market
          ...
          <div className="relative max-w-5xl mx-auto rounded-3xl border border-white/10 bg-gradient-to-b from-[#0E0E0E] to-[#0A0A0A] p-12 md:p-20 overflow-hidden text-center">
            ...
            <div className="relative">
              ...
              <p className="text-lg text-white/55 max-w-xl mx-auto mb-8">
                Explore the current EVE CXO product direction or contact the
                company about your requirements.
              </p>
              <Button
                size="lg"
