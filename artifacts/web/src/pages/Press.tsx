...
const FACTS = [
  ...
  { k: "Founded", v: "2025" },
  { k: "Flagship", v: "EVE CXO" },
  { k: "Product", v: "EVE CXO — The AI Operating System for Business" },
];

const LOGOS = [
  {
    label: "Wordmark - light on dark (SVG)",
    file: "/press/aicreatesai-wordmark-dark.svg",
  },
  {
    label: "Wordmark - dark on light (SVG)",
    file: "/press/aicreatesai-wordmark-light.svg",
  },
      ...
      <section className="relative pt-28 pb-14 md:pt-36 md:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              Boilerplate, fast facts, founder bio, logo downloads, and the
              right contact for media inquiries.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-14 relative">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-7 md:p-10 space-y-5 text-white/70 leading-relaxed">
            <p>
              AI Creates AI develops EVE CXO to help businesses coordinate
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-7 md:p-10 grid grid-cols-1 md:grid-cols-[160px_1fr] gap-8 items-start">
            <div className="w-40 h-40 rounded-2xl border border-white/10 bg-white/[0.03] overflow-hidden">
              <img
                src={sholomPortrait}
                alt="Sholom Hammond - Founder and CEO of AI Creates AI"
            ...
            <div>
              ...
              <div className="text-sm text-[#00F5D4] mt-1 mb-4">
                Founder & CEO, AI Creates AI
              </div>
              <p className="text-white/65 leading-relaxed mb-3">
                Sholom Hammond is the founder of AI Creates AI, the company
                behind EVE CXO.
              </p>
              <p className="text-white/55 leading-relaxed text-sm">
                ...
                <a
                  ...
                  className="text-white hover:text-[#00F5D4]"
                >
                  sholom@aicreates.ai
                </a>
                .
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {FACTS.map((f) => (
              ...
              >
                <dt className="text-[10px] uppercase tracking-[0.22em] text-white/40 mb-2">
                  {f.k}
                </dt>
      ...
      <section className="py-10 md:py-14 relative">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            ...
            {LOGOS.map((l) => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <ImageIcon
                    className="w-4 h-4 text-[#00F5D4] shrink-0"
                    strokeWidth={1.75}
                  />
                ...
                <Download
                  className="w-4 h-4 text-white/40 group-hover:text-[#00F5D4] shrink-0"
                  strokeWidth={1.75}
                />
              </a>
            ))}
          ...
          <p className="mt-4 text-xs text-white/40">
            For additional formats or media enquiries, email{" "}
            <a
              href="mailto:sholom@aicreates.ai"
              className="text-white/60 hover:text-[#00F5D4]"
            >
              sholom@aicreates.ai
            </a>
            .
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/litepaper">
              <div className="glass-card p-7 cursor-pointer hover:border-[#00F5D4]/30 transition-colors h-full">
                <FileText
                  className="w-5 h-5 text-[#00F5D4] mb-4"
                  strokeWidth={1.5}
                />
                ...
                <p className="text-white/55 text-sm leading-relaxed">
                  Long-form positioning, architecture, and roadmap.
                </p>
              </div>
            </Link>
            <Link href="/platform">
              <div className="glass-card p-7 cursor-pointer hover:border-[#00F5D4]/30 transition-colors h-full">
                ...
                <p className="text-white/55 text-sm leading-relaxed">
                  Adam, Eve, Jarvis, and the named architecture in one place.
                </p>
              </div>
            </Link>
            <Link href="/contact?interest=Press">
              <div className="glass-card p-7 cursor-pointer hover:border-[#00F5D4]/30 transition-colors h-full">
                ...
                <p className="text-white/55 text-sm leading-relaxed">
                  Reach out via the contact form, selecting Press.
                </p>
              </div>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="relative max-w-5xl mx-auto rounded-3xl border border-white/10 bg-gradient-to-b from-[#0E0E0E] to-[#0A0A0A] p-12 md:p-16 overflow-hidden text-center">
            ...
            <div className="relative">
              <Mail
                className="w-7 h-7 text-[#00F5D4] mx-auto mb-5"
                strokeWidth={1.5}
              />
