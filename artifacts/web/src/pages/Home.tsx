...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* HERO */}
      <section className="relative h-[100svh] sm:h-auto sm:min-h-[100svh] flex flex-col pt-20 pb-6 md:pt-28 md:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 sm:flex-1 sm:flex sm:items-center">
          <div className="relative max-w-5xl mx-auto text-center w-full">
            ...
            <motion.h1
              ...
              className="text-[34px] sm:text-5xl md:text-6xl lg:text-[88px] font-serif font-bold leading-[1.05] sm:leading-[1.02] mb-3 sm:mb-6 text-white tracking-tight [text-shadow:0_2px_36px_rgba(0,245,212,0.18),0_2px_24px_rgba(0,0,0,0.75)]"
            >
            ...
            <motion.p
              ...
              className="text-[14px] sm:text-lg md:text-xl text-white/75 max-w-2xl mx-auto leading-snug sm:leading-relaxed mb-5 sm:mb-8 [text-shadow:0_1px_16px_rgba(0,0,0,0.7)]"
            >
        ...
        <motion.div
          ...
          className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-x-6 gap-y-1 sm:gap-x-10 sm:gap-y-4 mt-6 sm:mt-auto pb-[12svh] sm:pb-0 md:pt-10 text-[10px] sm:text-xs uppercase tracking-[0.18em] sm:tracking-[0.2em] text-white/40"
        >
