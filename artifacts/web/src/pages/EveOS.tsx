...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-fuchsia-500/20 bg-fuchsia-500/5">
      ...
      <span className="text-[11px] font-medium uppercase tracking-[0.18em] text-fuchsia-100/70">
        {children}
      </span>
    </div>
  );
...
export default function EveOS() {
  ...
  const steps = [
    {
      icon: Crosshair,
      k: "01",
      title: t("eveos.how.steps.s1.title"),
      desc: t("eveos.how.steps.s1.desc"),
    },
    {
      icon: GitMerge,
      k: "02",
      title: t("eveos.how.steps.s2.title"),
      desc: t("eveos.how.steps.s2.desc"),
    },
    {
      icon: Layers,
      k: "03",
      title: t("eveos.how.steps.s3.title"),
      desc: t("eveos.how.steps.s3.desc"),
    },
    {
      icon: Repeat,
      k: "04",
      title: t("eveos.how.steps.s4.title"),
      desc: t("eveos.how.steps.s4.desc"),
    },
    {
      icon: Sparkles,
      k: "05",
      title: t("eveos.how.steps.s5.title"),
      desc: t("eveos.how.steps.s5.desc"),
    },
  ];
  ...
  const caps = [
    {
      icon: Megaphone,
      t: t("eveos.caps.items.marketing.t"),
      d: t("eveos.caps.items.marketing.d"),
    },
    {
      icon: TrendingUp,
      t: t("eveos.caps.items.sales.t"),
      d: t("eveos.caps.items.sales.d"),
    },
    {
      icon: Wallet,
      t: t("eveos.caps.items.finance.t"),
      d: t("eveos.caps.items.finance.d"),
    },
    {
      icon: Scale,
      t: t("eveos.caps.items.legal.t"),
      d: t("eveos.caps.items.legal.d"),
    },
    {
      icon: Workflow,
      t: t("eveos.caps.items.ops.t"),
    ...
    {
      icon: Target,
      t: t("eveos.caps.items.advertising.t"),
      d: t("eveos.caps.items.advertising.d"),
    },
  ];
  ...
  const diffs = [
    {
      icon: Network,
      tag: t("eveos.stands.diffs.d1.tag"),
      title: t("eveos.stands.diffs.d1.title"),
      desc: t("eveos.stands.diffs.d1.desc"),
    },
    {
      icon: CheckCircle2,
      tag: t("eveos.stands.diffs.d2.tag"),
      title: t("eveos.stands.diffs.d2.title"),
      desc: t("eveos.stands.diffs.d2.desc"),
    },
    {
      icon: Cpu,
      tag: t("eveos.stands.diffs.d3.tag"),
      title: t("eveos.stands.diffs.d3.title"),
      desc: t("eveos.stands.diffs.d3.desc"),
    },
  ];
  ...
  const team = [
    ...
    },
    {
      ...
      description: t(
        "eveos.team.marketing.desc",
        "Keeps your brand visible with campaigns, content, and performance insights.",
      ),
    ...
    },
    {
      ...
      description: t(
        "eveos.team.sales.desc",
        "Turns demand into momentum with lead intake, outreach, and pipeline support.",
      ),
    ...
    },
    {
      ...
      description: t(
        "eveos.team.advertising.desc",
        "Connects the right message to the right audience through focused paid media work.",
      ),
    ...
    },
    {
      ...
      description: t(
        "eveos.team.finance.desc",
        "Makes the numbers useful with budgets, forecasts, invoices, and financial reporting.",
      ),
    ...
    },
    {
      ...
      description: t(
        "eveos.team.operations.desc",
        "Keeps the business moving with repeatable workflows, logistics, and process clarity.",
      ),
    ...
    },
    {
      ...
      description: t(
        "eveos.team.legal.desc",
        "Brings structure to contracts, policy, compliance, and risk before work reaches you.",
      ),
      image: dianaPortrait,
      accent: "text-sky-300",
            ...
            <div className="max-w-3xl lg:col-span-7">
              ...
              >
                ...
                >
                  <Button
                    size="lg"
                    className="rounded-full h-12 px-7 bg-fuchsia-600 hover:bg-fuchsia-500 text-white border-0 shadow-[0_0_20px_rgba(217,70,239,0.3)] transition-all"
                  >
                    {t("eveos.hero.joinWaitlist")}{" "}
                ...
                <Link href="/litepaper">
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-full h-12 px-7 glass-btn hover:border-fuchsia-500/50 hover:text-fuchsia-400"
                  >
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mb-12 md:mb-16">
            <SectionLabel>
              {t("eveos.team.eyebrow", "Meet the team")}
            </SectionLabel>
            ...
            <p className="mt-6 text-lg text-white/55 leading-relaxed max-w-2xl">
              {t(
                "eveos.team.sub",
                "Eve keeps the whole company aligned while each specialist brings deep focus to the work. See who is behind every workflow.",
              )}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 md:p-8">
                ...
                <p className="mt-3 text-white/65 leading-relaxed">
                  {t(
                    "eveos.team.eve.desc",
                    "She takes the goal, routes the work, and brings one coordinated answer back to you.",
                  )}
                </p>
              </div>
            </motion.div>
            ...
            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {team.map((member, i) => (
                ...
                >
                  <div
                    className={`absolute inset-x-0 top-0 h-24 bg-gradient-to-b ${member.wash} to-transparent opacity-70`}
                  />
                  <div className="relative aspect-[4/3] overflow-hidden">
                    {member.image ? (
                      ...
                      <div className="h-full min-h-48 flex items-center justify-center bg-indigo-950/30">
                        <Cpu
                          size={64}
                  ...
                  <div className="relative px-5 pb-5 -mt-2">
                    <p
                      className={`text-[10px] uppercase tracking-[0.2em] ${member.accent}`}
                    >
                      {member.department}
                    </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 relative">
            ...
            {steps.map((s, i) => (
              ...
              >
                ...
                <h3 className="text-base font-serif font-semibold text-white mb-3 leading-tight">
                  {s.title}
                </h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {caps.map((c, i) => (
              ...
              >
                <c.icon
                  className="w-6 h-6 text-fuchsia-400 mb-5"
                  strokeWidth={1.5}
                />
                <h3 className="text-lg font-serif font-semibold text-white mb-2.5">
                  {c.t}
                </h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="relative max-w-5xl mx-auto rounded-3xl border border-fuchsia-500/20 bg-gradient-to-b from-[#18051E] to-[#0A0A0A] p-12 md:p-20 overflow-hidden text-center">
            ...
            <div className="relative">
              <Users
                className="w-8 h-8 text-fuchsia-400 mx-auto mb-6"
                strokeWidth={1.5}
              />
              ...
              >
                <Button
                  size="lg"
                  className="rounded-full h-12 px-8 bg-fuchsia-600 hover:bg-fuchsia-500 text-white border-0 shadow-[0_0_20px_rgba(217,70,239,0.3)] transition-all"
                >
                  {t("eveos.cta.button")}{" "}
                  <ArrowUpRight className="ms-2 w-4 h-4" />
                </Button>
